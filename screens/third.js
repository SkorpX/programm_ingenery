  ...
  return (
    ...
    <View style = {styles.statusbar}>
     ...
     <Pressable style={{width: 70, left: 20, top: 20,
      ...
      borderRadius: 10,}}><Text style ={styles.addbuttontext}>Еда</Text></Pressable>
      <Pressable style={{width: 130, left: 20, top: 35,
      paddingVertical: 5, paddingHorizontal: 15,
      backgroundColor: 'white',
      borderColor: 'black', borderWidth: 1,
      borderRadius: 10,}}><Text style ={styles.addbuttontext}>Транспорт</Text></Pressable>
      <Pressable style={{width: 120, left: 105, top:-50,
      paddingVertical: 5, paddingHorizontal: 15,
      backgroundColor: 'white',
      borderColor: 'black', borderWidth: 1,
      borderRadius: 10,}}><Text style ={styles.addbuttontext}>Квартира</Text></Pressable>
      <Pressable style={{width: 110, left: 165, top:-35,
      paddingVertical: 5, paddingHorizontal: 15,
      backgroundColor: 'white',
      borderColor: 'black', borderWidth: 1,
      borderRadius: 10,}}><Text style ={styles.addbuttontext}>Красота</Text></Pressable>
      <Pressable style={{width: 110, left: 20, top:-20,
      paddingVertical: 5, paddingHorizontal: 15,
      backgroundColor: 'white',
      borderColor: 'black', borderWidth: 1,
      borderRadius: 10,}}><Text style ={styles.addbuttontext}>Техника</Text></Pressable>
      ...
      backgroundColor: 'white',
      borderColor: 'black', borderWidth: 1,
      borderRadius: 10,}}><Text style ={styles.addbuttontext}>Путешествия</Text></Pressable>
      <Pressable style={{width: 110, left: 20, top: -25,
      paddingVertical: 5, paddingHorizontal: 15,
      backgroundColor: 'white',
      borderColor: 'black', borderWidth: 1,
      borderRadius: 10,}}><Text style ={styles.addbuttontext}>Одежда</Text></Pressable>
      <Pressable style={{width: 130, left: 150, top: -60,
      paddingVertical: 5, paddingHorizontal: 15,
      backgroundColor: 'white',
      borderColor: 'black', borderWidth: 1,
      borderRadius: 10,}}><Text style ={styles.addbuttontext}>Медицина</Text></Pressable>
      <Pressable style={{width: 110, left: 20, top: -45,
      paddingVertical: 5, paddingHorizontal: 15,
      backgroundColor: 'white',
      borderColor: 'black', borderWidth: 1,
      borderRadius: 10,}}><Text style ={styles.addbuttontext}>Другое</Text></Pressable>
    </View>
  );
};
