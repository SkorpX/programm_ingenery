  ...
  return (
    <View style={styles.app}>
      <View style={styles.statusbar}>
        ...
        />
        <Text style={styles.statusbartext}> План бюджета </Text>
      </View>
      ...
      <View style={styles.forview}>
        ...
        <TextInput
          ...
          placeholder="%"
          onChangeText={(sum1) => setsum1(sum1)}
        />
      </View>
      ...
      <View style={styles.forview}>
        ...
        <TextInput
          ...
          keyboardType="numeric"
          placeholder="%"
          onChangeText={(sum2) => setsum2(sum2)}
        />
      </View>

      <View style={styles.forview}>
        <Text style={styles.statusbartext}>Накопления:</Text>
        <TextInput
          style={styles.styleinput}
          keyboardType="numeric"
          placeholder="%"
          onChangeText={(sum3) => setsum3(sum3)}
        />
      </View>
      ...
      <Button
        title="Утвердить"
        onPress={() => {
          Number(sum1) + Number(sum2) + Number(sum3) != 100
            ? alert('Некорректная суммарная доля - не равна 100%')
