    ...
    <View style={styles.app}>
      <View style={styles.statusbar}>
        <AntDesign
          ...
          onPress={() => alert('hello')}
        />
        <Text style={styles.statusbar}> RazrabTeam </Text>
          ...
          <TouchableHighlight onPress={() => navigation.navigate('Story1')}>
            <View>
              ...
              <Text style={styles.storytext}>
                Узнайте о возможностях сбережений
              </Text>
            </View>
          </TouchableHighlight>
      ...
      <View style={styles.main}>
        <Text style={styles.maintext}>
          Анализ финансов пока недоступен: недостаточно данных
        </Text>
      </View>
      ...
      <Pressable
        ...
        <Text style={styles.buttontext}>Участники</Text>
      </Pressable>
      ...
      <Pressable style={styles.button}>
        <Text
          style={styles.buttontext}
          onPress={() => navigation.navigate('PlanExpense')}>
          Plan expense
        </Text>
      </Pressable>
    </View>
